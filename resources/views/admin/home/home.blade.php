        ...
        <div class="col-md-12 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold">Welcome Ostad Team</h3>
        ...
        <!-- <div class="col-md-6 grid-margin stretch-card">
            <div class="card tale-bg">
                <div class="card-people mt-auto">
                    <img src="{{asset('adminAsset')}}/assets/images/dashboard/people.svg" alt="people">
            ...
            <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                    <div class="card card-light-blue">
                        <div class="card-body">
                            <p class="mb-4">This Month Sales</p>
                ...
                <div class="col-md-6 stretch-card transparent">
                    <div class="card card-light-danger">
                        <div class="card-body">
                            <p class="mb-4">Last Month Sales</p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="icon-data-list">
                        <li>
                            <div class="d-flex">
                                <img src="{{asset('adminAsset')}}/assets/images/faces/face1.jpg" alt="user">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img src="{{asset('adminAsset')}}/assets/images/faces/face2.jpg" alt="user">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img src="{{asset('adminAsset')}}/assets/images/faces/face3.jpg" alt="user">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img src="{{asset('adminAsset')}}/assets/images/faces/face4.jpg" alt="user">
                                <div>
                        ...
                        <li>
                            <div class="d-flex">
                                <img src="{{asset('adminAsset')}}/assets/images/faces/face5.jpg" alt="user">
                                <div>
